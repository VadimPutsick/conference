sfdx force:org:create -s -f config/project-scratch-def.json -a conference-final^
 ...
 & sfdx force:data:tree:import --sobjecttreefiles data/Hotel__c.json -u test-vijnrdrrozki@example.com^
 & sfdx force:data:tree:import --sobjecttreefiles data/Interviewer__c.json -u test-vijnrdrrozki@example.com^
